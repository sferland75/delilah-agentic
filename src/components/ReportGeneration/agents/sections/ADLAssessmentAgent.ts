...
export class ADLAssessmentAgent extends BaseAgent {
    constructor() {
        super(ReportSection.ADL_ASSESSMENT);
    }
    ...
    private generateADLNarrative(adl: any): string {
        const sections = [];
    ...
    private formatSelfCareActivities(adl: any): string {
    ...
    private formatBathingSection(bathing: any): string {
        const details = [];
    ...
    private formatDressingSection(dressing: any): string {
        const details = [];
    ...
    private formatFeedingSection(feeding: any): string {
        const details = [];
    ...
    private formatTransfersSection(transfers: any): string {
        const details = [];
    ...
    private formatHomeManagement(adl: any): string {
        if (!adl.iadl?.household) return '';
    ...
    private formatWorkStatus(adl: any): string {
        if (!adl.work?.status) return '';
