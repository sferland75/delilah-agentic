...
exports.TherapistQualificationsAgent = void 0;
const BaseAgent_1 = require("../core/BaseAgent");
const ReportStructure_1 = require("../core/ReportStructure");
class TherapistQualificationsAgent extends BaseAgent_1.BaseAgent {
    constructor() {
        super(ReportStructure_1.ReportSection.THERAPIST_QUALIFICATIONS);
    }
...
exports.TherapistQualificationsAgent = TherapistQualificationsAgent;
